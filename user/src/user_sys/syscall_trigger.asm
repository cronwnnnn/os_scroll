...
SYSCALL_GET_TICKS_NUM     equ  13
SYSCALL_VIDEO_SET_MODE_NUM equ 14
SYSCALL_VIDEO_BLIT_NUM    equ  15
SYSCALL_VIDEO_SET_PALETTE_NUM equ 16
SYSCALL_POLL_KEYBOARD_EVENT_NUM equ 17
SYSCALL_GET_KEY_STATE_NUM equ 18
...
DEFINE_SYSCALL_TRIGGER_0_PARAM get_ticks, SYSCALL_GET_TICKS_NUM
DEFINE_SYSCALL_TRIGGER_1_PARAM video_set_mode, SYSCALL_VIDEO_SET_MODE_NUM
DEFINE_SYSCALL_TRIGGER_3_PARAM video_blit, SYSCALL_VIDEO_BLIT_NUM
DEFINE_SYSCALL_TRIGGER_4_PARAM video_set_palette, SYSCALL_VIDEO_SET_PALETTE_NUM
DEFINE_SYSCALL_TRIGGER_1_PARAM poll_keyboard_event, SYSCALL_POLL_KEYBOARD_EVENT_NUM
DEFINE_SYSCALL_TRIGGER_1_PARAM get_key_state, SYSCALL_GET_KEY_STATE_NUM
